...
#define LFT_BUTTON  128 /**< The Top Left button value for functions requiring a bitmask */
#define RGT_BUTTON   64 /**< The Top Right button value for functions requiring a bitmask */
